%\VignetteIndexEntry{Evaluating Model Fit of Logestic Regression Models for Propensity Score Analysis}
%\VignetteDepends{}
...
\title{Evaluating Model Fit of Logestic Regression Models for Propensity Score Analysis}
